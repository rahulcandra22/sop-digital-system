...
<head>
    ...
    <style>
        :root{--bg:#020617;--sb:rgba(15,23,42,.97);--tb:rgba(15,23,42,.87);--cb:rgba(30,41,59,.75);--gb:rgba(255,255,255,.08);--tm:#f8fafc;--tmut:#94a3b8;--tsub:#cbd5e1;--lf:brightness(0) invert(1);--lbg:rgba(239,68,68,.18);--lc:#fca5a5;--lbor:rgba(239,68,68,.30);--sl:#94a3b8;--sa:rgba(59,130,246,.12);--togbg:rgba(30,41,59,.80);--togc:#94a3b8;}
        [data-theme="light"]{--bg:#f0f4f8;--sb:rgba(255,255,255,.98);--tb:rgba(255,255,255,.96);--cb:rgba(255,255,255,.95);--gb:rgba(0,0,0,.09);--tm:#0f172a;--tmut:#64748b;--tsub:#334155;--lf:none;--lbg:rgba(239,68,68,.07);--lc:#dc2626;--lbor:rgba(239,68,68,.18);--sl:#64748b;--sa:rgba(59,130,246,.08);--togbg:rgba(241,245,249,.95);--togc:#475569;}
...
<body>
    <div class="dashboard-wrapper">
        ...
        <main class="main-content">
            <div class="topbar">
                <div class="topbar-left"><h2><i class="fas fa-folder" style="color:#3b82f6"></i> Kategori SOP</h2></div>
                        ...
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
                            ...
                            <div class="cat-card-lg">
                                <div style="position: relative; z-index: 1;">
                                    <div class="cat-icon-circle"><i class="fas fa-folder-open" style="font-size: 26px; color: #3b82f6;"></i></div>
                                    <h3><?php echo htmlspecialchars($cat['nama_kategori']); ?></h3>
                                    <p><?php echo htmlspecialchars($cat['deskripsi']); ?></p>
                                    <div style="display: flex; justify-content: space-between; align-items: center;">
                                        <span style="font-size: 13px; font-weight: 500; color: var(--tmut);"><i class="fas fa-file-alt"></i> <?php echo $cat['jumlah_sop']; ?> SOP</span>
