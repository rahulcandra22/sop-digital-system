    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form method="POST" id="formEditUser">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
                    <div class="form-group" style="margin-bottom:0"><label>Username <small style="color:var(--tmut);font-weight:400;text-transform:none">(juga termasuk email)</small></label><input type="text" name="username" id="edit_username" class="form-control" required><div class="field-error" id="error-edit-username" style="display:none"><i class="fas fa-exclamation-circle"></i><span></span></div></div>
