...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        /* ─── Modal Existing (Kategori) ─── */
        .modal { display: none; position: fixed; z-index: 9999; inset: 0; background: rgba(0,0,0,.65); backdrop-filter: blur(6px); }
        .modal-content { background: var(--mbg) !important; border: 1px solid var(--mbor) !important; border-radius: 16px; width: 92%; max-width: 700px; margin: 6% auto; box-shadow: 0 20px 50px rgba(0,0,0,.4); max-height: 88vh; overflow-y: auto; }
                ...
                <div class="confirm-box">
                    <label>
                        ...
                        <span class="confirm-text">
                            <strong>Saya menyatakan kategori ini belum tersedia di sistem
                            dan penambahan ini telah mendapat persetujuan.</strong>
                        </span>
                    </label>
                </div>
