                    ...
                    <div class="table-responsive">
                        <table id="sopTable">
                            ...
                            <tbody>
                                ...
                                <tr><td colspan="8" style="text-align:center;padding:24px;color:var(--tmut)">Belum ada SOP</td></tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    </div>
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
                    <div class="form-group" style="margin-bottom:0">
                        ...
                        <div class="field-hint blue">
                            ...
                            <span>Dokumen baru umumnya dimulai dari <strong style="color:#94a3b8">Draft</strong>. Status <strong style="color:#10b981">Disetujui</strong> hanya setelah review.</span>
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="margin-bottom:0">
                        ...
                        <div class="field-hint blue">
                            ...
                            <span>Format: PDF, DOCX, atau XLSX.</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="confirm-box" style="margin-top:16px">
                    <label>
                        ...
                        <span class="confirm-text">
                            <strong>Saya menyatakan dokumen SOP ini telah mendapat persetujuan,
                            ditulis dengan lengkap dan akurat, serta belum tersedia di sistem ini.</strong>
                        </span>
                    </label>
                </div>
            ...
            <form method="POST" enctype="multipart/form-data" id="formEditSOP">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
                    ...
                    <div class="form-group" style="margin-bottom:0">
                        ...
                        <input type="file" name="file_attachment" class="form-control">
                        <div class="field-hint blue" style="font-size:11px">
                            <i class="fas fa-info-circle"></i>
                            <span>Biarkan kosong jika tidak ingin mengganti file lama.</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="confirm-box" style="margin-top:16px">
                    <label>
                        ...
                        <span class="confirm-text">
                            <strong>Saya menyatakan revisi SOP ini sudah benar dan saya bertanggung jawab atas perubahan data.</strong>
                        </span>
                    </label>
                </div>
...
function searchTable(inputId, tableId) {
    ...
    for (i = 1; i < tr.length; i++) {
        td = tr[i].getElementsByTagName("td")[1]; // Search by Judul column
        if (td) {
...
function editSOP(id){
    ...
    // Fetch data JSON dari sop.php (bagian atas) untuk mengisi form
    fetch(window.location.href + '?action=get_data&id=' + id)
        .then(r => r.json())
        .then(data => {
            if(data.error) {
                alert(data.error); closeModal('editModal');
                return;
            }
